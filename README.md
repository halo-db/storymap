...
With help of Story Mapping (see below), we aim to work out, how the ideal HALO Database should look like. On that basis, we want to discuss how to proceed with the current HALO database. Is a complete remake desired? Or could a number of changes be implemented to appoach the ideal HALO database significantly?
